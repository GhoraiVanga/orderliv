...
<head>
    <title>Order Liv  Home Page</title>
            ...
            <div class="col-lg-10 scrollspy-example pr-0" data-spy="scroll" data-target="#spy">
                ...
                <div id="home" class="w3ls-banner d-flex  align-items-center justify-content-center">
                    <div class="bnr-w3pvt text-center">
                        <h4>Welcome to!!</h4>
                        <h2 class="bnr-txt-w3">OrderLiv</h2>
                        <p>Orderliv is World’s first 6 sense food recommendation Engine which enables Users to experience the next generation functionalities to improve their life style, health, focusing more on diet.</p>
                    ...
                    <div class="section">
                        ...
                        <div class="footer-bottom py-lg-5 py-3">
                            ...
                            <div class="footer-copy text-center">
                                <p class="text-dark">Wekart Incorporation @ 2021
